...
function main() {
    (0, _state.state).init();
    (0, _router.initRoute)(document.querySelector("#root"));
}
main();

},{"./state":"1Yeju","./router":"4QFWt","./components/title":"iClsj","./components/boton":"inIDM","./components/hand":"5jzIy","./components/countdown":"aGzWk","./components/jugada":"fxLzN","./components/score":"5XKJp"}],"1Yeju":[function(require,module,exports) {
...
const state = {
    ...
    whoWins (myPlay, computerPlay) {
        ...
        const computerGaneConPiedra = computerPlay == "piedra" && myPlay == "tijera";
        ...
        if (gane === computerGane) return "empate";
        else if (gane) return true;
        else if (computerGane) return false;
    },
    getHistory () {
        const curerntHistory = JSON.parse(localStorage.getItem("history"));
        return curerntHistory;
    },
    saveHistory (myPlay, computerPlay) {
        const currentHistory = this.getHistory();
        if (this.whoWins(myPlay, computerPlay) == true) currentHistory.user = currentHistory.user + 1;
        else if (this.whoWins(myPlay, computerPlay) == false) currentHistory.computer = currentHistory.computer + 1;
...
const router = [
    ...
    {
        path: /\/instruction/,
        component: (0, _instruction.initInstruction)
    },
    {
        path: /\/play/,
...
function initRoute(container) {
    ...
    function handleRoute(root) {
        ...
        for (let r of router)if (r.path.test(newRoute)) {
            let el = r.component({
                goTo
            });
...
},{"./pages/inicio":"eOBMs","./pages/instruction":"3NM0V","./pages/play":"hbEIY","./pages/result":"7wfLH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eOBMs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initWelcome", ()=>initWelcome);
const papel = require("706428b274ebfab2");
const tijera = require("c63d37851df4b5bd");
const piedra = require("426a482020a3a663");
...
},{"706428b274ebfab2":"brq0R","c63d37851df4b5bd":"5RLXy","426a482020a3a663":"ahMbM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"brq0R":[function(require,module,exports) {
...
},{}],"5RLXy":[function(require,module,exports) {
module.exports = require("aed99fcb0fa27c3b").getBundleURL("7UhFu") + "tijera.d3d2f5f9.png" + "?" + Date.now();

},{"aed99fcb0fa27c3b":"lgJ39"}],"ahMbM":[function(require,module,exports) {
module.exports = require("5060a788af7d1f1").getBundleURL("7UhFu") + "piedra.dbe546e3.png" + "?" + Date.now();

},{"5060a788af7d1f1":"lgJ39"}],"3NM0V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initInstruction", ()=>initInstruction);
const papel = require("23abab272e837618");
const tijera = require("976db99cb1a9c806");
const piedra = require("92cbe9fb59828064");
const fondo = require("af9ea972114d52b5");
function initInstruction(param) {
    const div = document.createElement("div");
    const style = document.createElement("style");
    div.classList.add("contenedor");
...
},{"23abab272e837618":"brq0R","976db99cb1a9c806":"5RLXy","92cbe9fb59828064":"ahMbM","af9ea972114d52b5":"foVaW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"foVaW":[function(require,module,exports) {
module.exports = require("8f872a5b288dd755").getBundleURL("7UhFu") + "fondo.e124efe6.png" + "?" + Date.now();

},{"8f872a5b288dd755":"lgJ39"}],"hbEIY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initPlay", ()=>initPlay);
var _state = require("../../state");
const papel = require("59ec0e4f3b1840b2");
const tijera = require("751b8557ee28848c");
const piedra = require("2dded2a7415c452d");
function initPlay(param) {
   ...
   `;
    ...
    const conteo = setInterval(()=>{
        const countdown = div.querySelector("custom-countdown")?.shadowRoot?.querySelector(".countdown-number")?.textContent;
        if (countdown < 1) {
    ...
    for (let el of hands)el.addEventListener("click", (e)=>{
        clearInterval(conteo);
        e.preventDefault();
        el.href = " ";
        for (let selec of hands)if (selec.getAttribute("id") !== el.getAttribute("id")) selec.remove();
        const numAleatorio = Math.ceil(Math.random() * 3);
        el.style.cssText = "margin-top:-70px;opacity:100%;justify-content: center;pointer-events: none;cursor: default";
        const countdown = div.querySelector("custom-countdown");
        countdown.style.display = "none";
        const computHands = div.querySelectorAll(".computer-hands custom-hand");
        const myPlay = e.target.getAttribute("id");
        for (let ele of computHands)if (Number(ele.getAttribute("id")) === numAleatorio) {
            (0, _state.state).setMove(myPlay, ele.getAttribute("type"));
...
},{"../../state":"1Yeju","59ec0e4f3b1840b2":"brq0R","751b8557ee28848c":"5RLXy","2dded2a7415c452d":"ahMbM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7wfLH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initResult", ()=>initResult);
var _state = require("../../state");
function initResult(param) {
    const div = document.createElement("div");
    div.classList.add("contenedor");
    ...
    (0, _state.state).saveHistory(currentState.currentGame.myPlay, currentState.currentGame.computerPlay);
    div.innerHTML = ` 
...
},{"../../state":"1Yeju","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iClsj":[function(require,module,exports) {
class Title extends HTMLElement {
    ...
    render() {
        ...
        const style = document.createElement("style");
        div.innerHTML = `
         <h2 class=${instruction.length > 53 ? "instruction" : "titulo"} >${instruction}</h2>
         `;
        style.innerHTML = `
            .titulo{
               font-size:5rem;
...
},{}],"5jzIy":[function(require,module,exports) {
...
class Countdown extends HTMLElement {
    ...
    `;
        let cantidad = 5;
        const countNumber = div.querySelector(".countdown-number");
        let tiempo = setInterval(()=>{
            cantidad--;
            countNumber.innerHTML = cantidad.toString();
            if (cantidad < 1) clearInterval(tiempo);
        }, 1000);
        shadow.appendChild(div);
        shadow.appendChild(style);
    }
...
const perdistes = require("834187df4958d9b3");
const ganastes = require("3b1a579d05c43d89");
customElements.define("custom-jugada", class extends HTMLElement {
    constructor(){
        super();
        this.render();
    }
    render() {
        ...
        function eleccion() {
            if (jugada === "empate") return "Empate";
            else if (jugada === "true") return "Ganastes";
            else return "Perdistes";
        }
        div.innerHTML = `
               <h2 class="titulo titulo-${eleccion()}">${eleccion()}</h2>
               <img src="${jugada == "true" ? ganastes : perdistes}" class="${eleccion()}"/>
            `;
        const style = document.createElement("style");
        style.innerHTML = `
               .titulo{
...
},{"834187df4958d9b3":"3GQ1B","3b1a579d05c43d89":"ioWuU"}],"3GQ1B":[function(require,module,exports) {
module.exports = require("d82619b6c88f8948").getBundleURL("7UhFu") + "perdiste.cb762c77.png" + "?" + Date.now();

},{"d82619b6c88f8948":"lgJ39"}],"ioWuU":[function(require,module,exports) {
module.exports = require("7197f6991aa47b47").getBundleURL("7UhFu") + "ganastes.212c9d31.png" + "?" + Date.now();

},{"7197f6991aa47b47":"lgJ39"}],"5XKJp":[function(require,module,exports) {
var _state = require("../../state");
customElements.define("custom-score", class extends HTMLElement {
    ...
    render() {
        ...
        const userScore = (0, _state.state).getHistory().user;
        const computerScore = (0, _state.state).getHistory().computer;
        div.innerHTML = `
               <h3>Score</h3>
               <div class="puntos">
                  <h4>Vos : ${userScore}</h4>
...
},{"../../state":"1Yeju"}]},["2oZg2","h7u1C"], "h7u1C", "parcelRequire9acc")
